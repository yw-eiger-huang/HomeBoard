...
- **Group items of similar purpose together**: within a spec file, sections that cover the same subsystem (e.g. board construction, annotations, rendering, projection) should be co-located. Use `## ── Group Name ──` headers to delimit topic groups.
