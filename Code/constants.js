...
export const CEIL_H = 2.5, T = 0.018, T_FRAME = T + 0.027, HT = T_FRAME / 2;
...
export const MAIN_DIV_WIDTHS = [0.48, 0.90, 0.90, 0.90, 0.48]; // division widths along Z (main board)
export const FOLD_DIV_WIDTHS = [1.18, 1.30, 1.18];             // division widths along Z (fold board)
